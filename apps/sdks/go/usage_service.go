...
func (s *UsageService) CheckEntitlement(params map[string]string) (interface{}, error) {
...
func (s *UsageService) Create() (interface{}, error) {
		path := "/usage/events"
...
func (s *UsageService) Get(id string) (interface{}, error) {
...
func (s *UsageService) GetRevenue(params map[string]string) (interface{}, error) {
		path := "/usage/revenue"
		bodyResp, err := s.client.doRequest("GET", path, paramsToQuery(params), nil)
		if err != nil {
			return nil, err
...
func (s *UsageService) ListPeriods(params map[string]string) (interface{}, error) {
		path := "/usage/periods"
		bodyResp, err := s.client.doRequest("GET", path, paramsToQuery(params), nil)
		if err != nil {
			return nil, err
