...
export class PaymentRequestsService {
     ...
     */
    public async create(body: NonNullable<paths['/payment-requests']['post']['requestBody']>['content']['application/json'], options?: import("../../request-options.js").LomiRequestOptions): Promise<components['schemas']['PaymentRequestResponseDto']> {
        return requestWithClient<components['schemas']['PaymentRequestResponseDto']>(this.client, {
            method: 'POST',
     ...
     */
    public async get(id: string, options?: import("../../request-options.js").LomiRequestOptions): Promise<components['schemas']['PaymentRequestResponseDto']> {
        return requestWithClient<components['schemas']['PaymentRequestResponseDto']>(this.client, {
            method: 'GET',
