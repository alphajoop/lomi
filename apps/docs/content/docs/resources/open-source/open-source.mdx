...
We offer both an open-source solution and a hosted platform to meet the needs of merchants and developers. In line with our vision of transparency and community collaboration, we follow a **dual-license approach**.
...
For details on the codebase layout, see the [codebase](/resources/open-source/codebase) page.
