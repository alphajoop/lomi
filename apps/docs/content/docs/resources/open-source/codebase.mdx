...
- **Currently open-source**:
  ...
  - Storefront boilerplate + Medusa: **[apps/store](https://github.com/lomiafrica/store/)**
  - Events boilerplate + Sanity: **[apps/events](https://github.com/lomiafrica/events/)**
