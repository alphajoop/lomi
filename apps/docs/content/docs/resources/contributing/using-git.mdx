---
title: 'Using git'
description: 'Use Git from the command line when collaborating on your lomi. integration or open-source contributions.'
---
...
Replace `develop` with the appropriate branch name if you're using a different branching strategy.
...
Again, replace `develop` with the appropriate branch name if necessary.
...
By using Git effectively and following best practices, you can collaborate smoothly on your lomi. integration.
