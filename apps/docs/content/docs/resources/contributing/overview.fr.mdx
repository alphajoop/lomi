...
4. **Miroirs site** : `cd apps/website && node src/lib/scripts/sync-openapi.mjs`, puis committer `public/openapi.json` et `public/agent-openapi.json` dans le dépôt `lomiafrica/website` et mettre à jour le sous-module.
