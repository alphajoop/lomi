...
Cette page est le **contrat d'écriture canonique** pour la documentation développeur lomi. Elle fusionne le contrat de style API, les types Diátaxis et les règles de marque du monorepo.
...
| `how-to` | Étapes orientées tâche | [Vérifier les paiements](/build/guides/verify-payments) |
...
- **Ne jamais faire confiance au seul succès côté client** — voir [Vérifier les paiements](/build/guides/verify-payments).
...
- [Recevoir les webhooks](/build/advanced-guides/handling-webhooks)
...
- [Brief design CORE-38](https://github.com/lomiafrica/lomi.) — `apps/design/docs/note.md` dans le monorepo
