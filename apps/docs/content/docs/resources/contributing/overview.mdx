...
4. **Website mirrors**: `cd apps/website && node src/lib/scripts/sync-openapi.mjs`, then commit `public/openapi.json` and `public/agent-openapi.json` in the `lomiafrica/website` repo and bump the monorepo submodule pointer.
...
- Familiarize yourself with our [Code of conduct](/resources/contributing/code-of-conduct).
- Understand our [Branching strategy](/resources/contributing/branching-strategy).
- Learn about the [Code review](/resources/contributing/code-reviews) process in more detail.

Your PR will be reviewed by maintainers according to our [Code Review](/resources/contributing/code-reviews) process. Be prepared to respond to feedback and make further changes if necessary. We'll be fast to respond to you, don't you worry!
