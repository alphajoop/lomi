...
Outil de documentation CLI (CORE-38). **Dépôt autonome :** [github.com/lomiafrica/doctool](https://github.com/lomiafrica/doctool) (pas un sous-module git).
...
Documentation mainteneur : [`apps/doctool/CONTRIBUTING.md`](https://github.com/lomiafrica/doctool/blob/main/CONTRIBUTING.md)
...
| OpenAPI agent | `cd apps/api && pnpm run openapi:export:agent` → `apps/docs/agent-openapi.json` |
...
- [Vue d’ensemble contributing](/resources/contributing/overview)
- [Rédiger pour la doc lomi.](/resources/contributing/writing-for-lomi-docs)
