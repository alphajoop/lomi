---
title: "Retrieve customer subscription"
description: "Retrieve customer subscription"
full: true
method: get
...
Returns one customer-scoped subscription by ID. Responds with **404** when unknown or inaccessible.
