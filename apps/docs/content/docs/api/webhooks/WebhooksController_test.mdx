...
Sends a sample event to the configured URL so you can validate signature verification and parsing.


### When to use this

Use immediately after creating or updating a webhook endpoint.
