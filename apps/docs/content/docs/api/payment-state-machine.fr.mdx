...
Voir [Transactions](/build/transactions) pour les champs dans les réponses API.
...
Pour le délai de disponibilité des fonds, voir [Solde et règlement](/build/balance-and-settlement).

## Voir aussi

- [Cycle de vie des paiements](/build/guides/payment-lifecycle)
- [Vérifier les paiements](/build/guides/verify-payments)
- [Comportement du checkout](/build/payments/checkout-behavior)
