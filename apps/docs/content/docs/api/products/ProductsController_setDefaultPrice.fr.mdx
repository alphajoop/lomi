...
`POST /products/{id}/prices/{priceId}/default`
...
```bash
curl -sS -X POST "https://sandbox.api.lomi.africa/products/value/prices/value/default" \
...
- **operationId**: `ProductsController_setDefaultPrice`
- **Operation**: `POST /products/{id}/prices/{priceId}/default`
