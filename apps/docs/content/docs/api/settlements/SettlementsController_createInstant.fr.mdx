...
Le mode rail enregistre des frais Nitro sur un retrait existant. Le mode avance débloque les fonds carte retenus jusqu’au plafond de l’organisation. Exige `Idempotency-Key`. L’avance reste off jusqu’à ce qu’ops approuve un plafond.
