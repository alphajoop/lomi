...
| `require_billing_address` | Non | `boolean` | When true, show and require billing address on checkout. |
| `require_email` | Non | `boolean` | When true, show and require customer email. Default true when unset. |
| `require_phone` | Non | `boolean` | When true, show and require customer phone. Default false when unset. |
