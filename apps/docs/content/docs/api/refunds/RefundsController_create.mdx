...
Refunds a **completed** transaction on **Stripe (card)**, **Wave**, or **MTN MoMo**. Merchant balance updates immediately when the refund is recorded.
...
| --- | --- | --- | --- |
| `transaction_id` | Yes | `string` | UUID of a completed transaction (card, Wave, or MTN MoMo) |
