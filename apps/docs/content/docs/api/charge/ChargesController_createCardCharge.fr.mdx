---
title: "Créer un encaissement carte (client_secret)"
description: "Créer un encaissement carte (client_secret)"
full: true
method: post
path: /charge/card
...
Utilisez cet endpoint pour `POST /charge/card` (Créer un encaissement carte (client_secret)).
