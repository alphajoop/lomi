...
- **[Sessions checkout](/build/accept/checkout)**: API checkout hébergé
- **[Encaissements directs](/build/accept/direct-charges)**: Wave, MTN et carte (`POST /charge/card`)
- **[Liens de paiement](/build/accept/payment-links)**: liens réutilisables
- **[lomi Payment Elements](/build/accept/payment-elements)**: UI carte côté client
- **[Webhooks](/build/reliability)**: abonnements aux événements
- **[Soldes et règlement](/build/money/balance-and-settlement)**: règles des soldes live
- **[Guide de tests](/build/reliability/testing)**: automatisation, CI, écouteurs webhook
