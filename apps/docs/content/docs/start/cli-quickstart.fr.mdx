---
title: 'Démarrer avec la CLI'
description: 'Installez la CLI lomi., connectez-vous, lancez quickstart, créez un checkout de test et recevez les webhooks en local.'
---
