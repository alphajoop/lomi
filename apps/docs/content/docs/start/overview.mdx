...
| Compare REST API, SDK, CLI, and MCP | [How you call lomi.](/start/integration-journey#how-you-call-lomi) |
...
- [Choose an integration](/build/choose-integration) · [Products](/build/products) · [SDKs](/build/sdks) · [CLI](/build/cli) · [MCP](/build/mcp)
