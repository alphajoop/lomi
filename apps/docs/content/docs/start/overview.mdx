...
- **APIs**: one integration for cards, MTN MoMo, Wave, Orange Money, SPI (64+ mobile money operators and banks), and more.
...
- **Open source**: most of the codebase is public — see [codebase structure](/resources/open-source/codebase).
