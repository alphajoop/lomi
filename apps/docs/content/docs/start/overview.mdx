...
The docs landing map at [/](/) lists Start, Build, and API. Pick a surface (API, SDK, CLI, or MCP) on [How to use lomi.](/start/integration-journey#how-you-call-lomi), then open the product guide when you need the full story.
