...
- **[Checkout sessions](/build/accept/checkout)**: hosted checkout API
- **[Direct charges](/build/accept/direct-charges)**: Wave, MTN, and embedded card (`POST /charge/card`)
- **[Payment links](/build/accept/payment-links)**: reusable pay links
- **[lomi Payment Elements](/build/accept/payment-elements)**: client-side card UI
- **[Webhooks](/build/reliability)**: event subscriptions
- **[Balance and settlement](/build/money/balance-and-settlement)**: live balance rules
- **[Testing guide](/build/reliability/testing)**: automation, CI, webhook listeners
