...
5. Cas limites checkout (abonnements, essais, mobile money en attente) : [Comportement checkout](/build/payments/checkout-behavior) et guides par canal sous [Canaux de paiement](/build/payment-channels#chemin-recommandé-par-canal).
