...
<DocsScreenshot name="build/subscriptions" alt="lomi. dashboard subscription detail with plan status and billing period" />
...
4. For failed renewals, use the [customer portal retry payment](/docs/build/customer-portal#failed-payment-recovery) headless endpoint or redirect customers to the hosted portal billing/subscriptions pages.
