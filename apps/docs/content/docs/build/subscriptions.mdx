...
**API reference:** [Subscriptions by customer](/api/subscriptions/SubscriptionsController_findByCustomer)
...
**API reference:** [Uncancel subscription](/api/subscriptions/SubscriptionsController_uncancel)
...
- [Subscriptions by customer](/api/subscriptions/SubscriptionsController_findByCustomer)
- [Cancel subscription](/api/subscriptions/SubscriptionsController_cancel)
- [Uncancel subscription](/api/subscriptions/SubscriptionsController_uncancel)
