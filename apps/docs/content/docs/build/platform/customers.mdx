...
Generate a one-time hosted customer portal URL from your backend. Returns `launch_url` for redirect. See [Customer portal](/build/billing/customer-portal) for flows, security, and production setup.
...
- [Customer portal guide](/build/billing/customer-portal)
