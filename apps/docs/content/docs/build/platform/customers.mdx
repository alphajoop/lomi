...
**API reference:** [Portal launch session](/api/customers/CustomersController_createPortalLaunchSession)
...
- [Portal launch session](/api/customers/CustomersController_createPortalLaunchSession)
