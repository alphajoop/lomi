...
**Référence API :** [Session de lancement portail](/api/customers/CustomersController_createPortalSession)

Génère une URL portail hébergée à usage unique depuis votre backend. Retourne `launch_url` pour la redirection. Voir [Portail client](/build/billing/customer-portal) pour les flux, la sécurité et la configuration production.
...
- [Session de lancement portail](/api/customers/CustomersController_createPortalSession)
- [Guide portail client](/build/billing/customer-portal)
