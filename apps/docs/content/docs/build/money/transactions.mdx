...
<Callout type="info">
  **Behavior:** how statuses transition, when balances credit, and how expiration works, see **[Payment state machine](/api/payment-state-machine)** and **[Balance and settlement](/build/money/balance-and-settlement)**.
</Callout>
