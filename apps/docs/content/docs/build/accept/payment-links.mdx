...
<DocsScreenshot name="build/payment-links" alt="Payment links list in lomi. dashboard" />
...
Use [hosted checkout](/build/accept/checkout) instead when every payment should be created from your backend order flow.
