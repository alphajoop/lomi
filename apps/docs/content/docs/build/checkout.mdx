...
| `require_name` / `require_email` / `require_phone` / `require_billing_address` | Optional, control checkout form fields; see [Checkout form fields](/build/payments/checkout-behavior#checkout-form-fields) |
