...
- [Payouts](/build/payouts)
- [Payouts](/build/payouts) (self withdrawal and beneficiary)
...
Fee resolution may use tier-aware helpers for payout categories. For high-level pricing modes, see [Merchant of record pricing](/resources/merchant-of-record/pricing).
