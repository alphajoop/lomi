...
- [`apps/plugins/direct-charge-integration-reference`](https://github.com/lomiafrica/plugins/tree/main/direct-charge-integration-reference) — server proxy, Payment Element UI, and cURL scripts

For hosted checkout sessions instead, see [`payment-integration-reference`](https://github.com/lomiafrica/plugins/tree/main/payment-integration-reference).
