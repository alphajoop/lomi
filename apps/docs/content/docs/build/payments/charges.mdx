...
- [`apps/plugins/direct-charge-integration-reference`](https://github.com/lomiafrica/lomi./tree/main/apps/plugins/direct-charge-integration-reference): server proxy, Payment Element UI, and cURL scripts

For hosted checkout sessions instead, see [`payment-integration-sdk-reference`](https://github.com/lomiafrica/lomi./tree/main/apps/plugins/payment-integration-sdk-reference).
