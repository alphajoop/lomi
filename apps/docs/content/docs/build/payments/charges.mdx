...
description: Collect money via Wave, MTN, or embedded card (POST /charge/*).
---
...
See [Create card charge](/api/charge/ChargesController_createCardCharge) and [lomi Payment Elements](/build/payments/lomi-payment-elements).
...
- [`apps/plugins/references/direct-charge-integration-reference`](https://github.com/lomiafrica/lomi./tree/main/apps/plugins/references/direct-charge-integration-reference): server proxy, Payment Element UI, and cURL scripts

For hosted checkout sessions instead, see [`payment-integration-sdk-reference`](https://github.com/lomiafrica/lomi./tree/main/apps/plugins/references/payment-integration-sdk-reference).

## MTN direct charge

`POST /charge/mtn`, same pattern as Wave; see [Create MTN charge](/api/charge/ChargesController_createMtnCharge).
