...
<Callout type="info">
  **Contact :** le tunnel collecte toujours au moins un moyen de joindre le client. Si l’e-mail est masqué et le téléphone optionnel, le téléphone devient obligatoire. Si e-mail et téléphone sont visibles, l’e-mail est obligatoire et le téléphone reste optionnel sauf si vous passez `require_phone: true`.
</Callout>
...
1. **Session checkout** (`require_email`, `require_phone`, `require_billing_address` sur `POST /checkout-sessions`)
