...
- [`apps/plugins/references/direct-charge-integration-reference`](https://github.com/lomiafrica/lomi./tree/main/apps/plugins/references/direct-charge-integration-reference) : proxy serveur, UI Payment Element et scripts cURL

Pour les sessions checkout hébergées, voir [`payment-integration-sdk-reference`](https://github.com/lomiafrica/lomi./tree/main/apps/plugins/references/payment-integration-sdk-reference).
