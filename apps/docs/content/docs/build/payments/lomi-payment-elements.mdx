...
<Tabs items={['Web (JS)', 'React Native', 'Embedded Checkout']}>
  ...
  <Tab value="Embedded Checkout">
    See the full guide: [Embed checkout widget](/build/embed-widget).
...
See [Webhooks Documentation](/build/webhooks) for setup details.
...
For sandbox test card numbers, mobile money (Wave, MTN MoMo), hosted checkout QA, and test balances, see **[Sandbox payments](/start/sandbox-payments)**.
