...
<DocsScreenshot name="build/customer-portal" alt="lomi. customer portal payments or subscriptions list" />
...
1. Create a Stripe SetupIntent via `POST /customer-portal/payment-methods/setup-intent`
2. Confirm the SetupIntent client-side with Stripe.js
