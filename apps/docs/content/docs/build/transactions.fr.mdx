...
<Callout type="info">
  **Comportement :** transitions de statut, crédit des soldes, expiration, voir **[Machine à états du paiement](/api/payment-state-machine)** et **[Solde et règlement](/build/balance-and-settlement)**.
</Callout>
