...
| `customers` | `list`, `get`, `create`, `update`, `delete`, `getTransactions`, `createPortalLaunchSession`, `getPortalAudit` |
...
| `subscriptions` | `list`, `get`, `findByCustomer`, `cancel`, `uncancel`, `changePlan`, `update` |
| `transactions` | `list`, `get` |
| `webhookDeliveryLogs` | `list`, `get` |
| `webhooks` | `list`, `get`, `create`, `update`, `delete`, `test`, `retryDelivery` |
