...
| `require_email` / `require_phone` / `require_billing_address` | Optionnel — contrôle les champs du formulaire ; voir [Champs du formulaire checkout](/build/payments/checkout-behavior#checkout-form-fields) |
