...
| Situation | Use |
| --- | --- |
| WooCommerce, Magento, PrestaShop, Shopify, or Bubble store | Official [e-commerce extensions](/build/ecommerce-extensions) |
| Custom site with minimal UI work | [Embed widget](/build/accept/embed-widget) |
| Full control over checkout UI in your React app | **lomi-ui** (this page) |
| Backend-only integration | [Public API](/start/first-payment) or [SDKs](/build/sdks) |
