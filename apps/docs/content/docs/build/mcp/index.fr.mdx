...
## Auto-hébergement du serveur MCP

La plupart des développeurs utilisent `https://mcp.lomi.africa` ou le stdio local. Pour déployer votre propre instance, voir [`apps/mcp`](https://github.com/lomiafrica/lomi./tree/master/apps/mcp) et `.env.example` (`LOMI_MCP_BEARER_TOKEN`, `LOMI_API_BASE_URL`, etc.).
