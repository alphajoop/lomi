...
**Référence API :** [Abonnements par client](/api/subscriptions/SubscriptionsController_findByCustomer)
...
**Référence API :** [Annuler la résiliation](/api/subscriptions/SubscriptionsController_uncancel)
...
- [Abonnements par client](/api/subscriptions/SubscriptionsController_findByCustomer)
- [Annuler un abonnement](/api/subscriptions/SubscriptionsController_cancel)
- [Annuler la résiliation](/api/subscriptions/SubscriptionsController_uncancel)
...
- [Comportement du tunnel : abonnements](/build/payments/checkout-behavior#subscription-checkout)
