...
Les retraits importants ou très fréquents peuvent être retenus automatiquement. En cas d’erreur liée au risque sur `POST /payouts`, réessayez plus tard ou [contactez le support](/resources/support).

<Callout type="info">
  Pour l’analyse des risques sur les **paiements entrants** (carte et mobile money), voir [lomi. Radar](/build/radar).
</Callout>
