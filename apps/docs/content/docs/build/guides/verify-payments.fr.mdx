---
title: 'Comment vérifier un paiement avant de livrer ?'
...
Voir [Machine à états du paiement](/api/payment-state-machine) et [Gestion des webhooks](/build/advanced-guides/handling-webhooks).
