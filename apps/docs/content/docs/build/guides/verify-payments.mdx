---
title: 'How do I verify a payment before fulfilling?'
...
See [Payment state machine](/api/payment-state-machine) for status meanings and [Handling webhooks](/build/advanced-guides/handling-webhooks) for signature verification.
