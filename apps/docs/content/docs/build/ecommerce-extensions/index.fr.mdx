...
WooCommerce, Magento 2 et PrestaShop n’utilent que l’**API REST publique** lomi. (`/checkout-sessions`). Ils **n’appellent pas** les RPC Supabase ni les endpoints internes Nest.
...
| Vendre depuis un catalogue hébergé (sans plugin boutique) | **[Storefront](https://store.lomi.africa)** avec [Produits](/build/products) (`display_on_storefront`) |
