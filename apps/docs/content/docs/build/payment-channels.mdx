...
Use this page to confirm which rails and currencies you can offer before you pick an integration path. For the decision tree, see [Which payment integration should I choose?](/build/choose-integration).
...
| Channel | Hosted checkout / links | Direct API |
| --- | --- | --- |
| Cards (Visa, Mastercard, Amex, …) | Yes | `POST /charge/card` + Payment Elements |
| Wave | Yes | `POST /charge/wave` |
| MTN MoMo | Yes | `POST /charge/mtn` |
| Orange Money, SPI, bank transfer | Yes (hosted) | Use hosted checkout unless documented otherwise |
