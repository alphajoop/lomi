...
Worked examples (stacking, eligibility edge cases, retries): **[Coupon logic examples](/build/payments/coupon-logic-examples)**.
...
1. Create a coupon via **`POST /discount-coupons`** with your constraints.
