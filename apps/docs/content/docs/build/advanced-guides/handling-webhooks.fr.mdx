...
Voir le [guide des tests](/build/advanced-guides/testing) pour utiliser le Dashboard lomi. ou le CLI et envoyer des événements de test vers votre URL local.
