...
description: 'Mettre en œuvre une sécurité solide est indispensable lorsque vous traitez des paiements et intégrez des API tierces comme lomi. Suivez ces recommandations pour une intégration sécurisée.'
---
...
Voir [Configurer les webhooks](/build/webhooks) et [Traiter les webhooks](/build/advanced-guides/handling-webhooks) pour le détail.
...
- [Clés d’idempotence](/build/advanced-guides/idempotency-keys)
- [Référence API](/api)
